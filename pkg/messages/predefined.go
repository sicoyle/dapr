...
var (
	...
	ErrWorkflowNameReserved          = APIError{"workflow name %q uses the reserved %q prefix", errorcodes.WorkflowNameReserved, http.StatusBadRequest, grpcCodes.InvalidArgument}
